...
if __name__ == "__main__":
        ...
        threshold_multiplier = 0.2 # if too low (<0.4), detection check shows ungesture instead of gesture, if too high, gesture are too much segmented
        ...
        start_xaccel, end_xaccel, start_yaccel, end_yaccel, start_zaccel, end_zaccel = SIGNAL.all_calculations(
                ...
                normalised_timestamp_acc, sigma, threshold_multiplier, true_mvmt, 101.36034736268958794910257398123)
